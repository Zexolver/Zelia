...
class FileTool:
    ...
    def resolve(self, path: str) -> str:
        """Absolute on-disk path for `path` relative to the workspace,
        after checking it doesn't escape the workspace directory. Public
        so callers that need the real path (e.g. coding_agent.py tracking
        which files it already wrote) don't have to reimplement this
        check themselves."""
